    ...
    <section className="message-section">
      ...
      >
        ...
        <h2 className="message-title">
          ...
          <span className="signature">حبيبة ❤️</span>
        </h2>
        ...
        >
          ...
          من 14/7/2025، يوم ما اتقبلنا فيه، وأنا كل شوية باكتشف حاجة تانية تخليني أحبك أكتر.
        ...
        >
          بحبك يا حبيبة بجد، إنتي أجمل وأغلى وأهم حاجة في حياتي، وربنا يخليكي ليا ويفضل يضحكك طول عمرك ❤️🌹
        </motion.p>
      </motion.div>
    </section>
  )
